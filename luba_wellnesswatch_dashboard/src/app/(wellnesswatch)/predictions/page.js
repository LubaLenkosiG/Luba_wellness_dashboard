...
const diseases = ["Diabetes", "Hypertension", "Kidney Disease"];
  ...
  const renderRow = (patient) => {
    ...
    return (
      ...
      >
        ...
        <td className="hidden md:table-cell">{(patient.riskDetails).replace("."," ")}:&nbsp;{ patient.confidence}%</td>
    ...
    <div className="p-4 bg-transparent">
      <div className="flex flex-col justify-center gap-8">
        <div className="flex justify-between items-center max-sm:flex-col">
          ...
          <div className="flex items-center justify-between gap-2 p-2 max-sm:grid-cols-1 max-sm:grid w-[33%] max-sm:w-full">
      ...
      {isUpdateDialogVisible && (
        <UpdatePatient onClickClose={handleCancelUpdate} patientData={patientToUpdate} />
      )}
    </div>
  );
};
